...
import com.zjtachao.fish.kiss.data.service.device.impl.KissDeviceHandleServiceImpl;
...
public class KissDeviceRunner implements CommandLineRunner {
    ...
    public void run(String... strings){
        try {
            logger.info("开始加载启动服务");
            kissDeviceHandleService.nettyChannelStart();
            kissDeviceHandleService.sendHeartBeat();
            logger.info("完成加载启动服务");
        }catch (Exception ex){
